...
> = {
  publicTransportation: {
    ...
    nowCanChange: [
      ...
      {
        title: '체계적인 자산관리 시스템 구축',
        content:
          '완벽한 계획이어도 실천이 없으면 무용지물입니다. Olass를 통해 당신만의 자산관리 시스템을 구축하고 꾸준히 실천해보세요.',
      },
    ],
  },
  avante: {
    ...
    nowCanChange: [
      ...
      {
        title: '다음 자산 레벨을 설계하세요. ',
        content:
          '완벽한 계획이 있어도 행동이 없다면 아무 의미 없습니다. Olass는 사용자의 패턴을 분석해, 5년 내 상위 30% 자산가를 목표로 실행 가능한 자산관리 로드맵을 제공합니다.',
      },
    ],
  },
  grandeur: {
    ...
    nowCanChange: [
      ...
      {
        title: '‘플랜 B’를 만들어야 합니다.',
        content:
          '1가지 플랜만 있는 자산 관리는 언제든 흔들릴 수 있습니다. Olass는 비상지출, 투자 손실 등을 고려한 복수 시나리오 기반 자산 계획을 제안합니다.',
      },
    ],
  },
  benz: {
    ...
    nowCanChange: [
      ...
      {
        title: '‘비용’보다 ‘기회비용’을 생각해야 할 때입니다.',
        content:
          '지금 당장 벤츠에 대한 구매보다, 그만큼의 자산을 지금 쓰는 게 맞는지를 판단할 수 있는 기준이 필요합니다. Olass는 그런 ‘의사결정력’을 데이터 기반으로 도와드립니다.',
      },
    ],
  },
  porsche: {
    ...
    nowCanChange: [
      ...
      {
        title: '지금의 소비가 미래의 여유를 줄이지 않게 하세요',
        content:
          '당장은 감당할 수 있더라도, 10년 뒤에도 같은 재정 여유가 있을지는 다른 문제입니다. Olass는 지금의 지출이 미래 자산에 미치는 영향을 시뮬레이션해, 한순간의 소비로 여유가 사라지지 않도록 설계해드립니다.',
      },
    ],
  },
};
